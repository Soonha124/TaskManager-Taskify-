    ...
    {
        private val sharedPreferences = context.getSharedPreferences("UserPrefs",
            Context.MODE_PRIVATE)

        fun isLoggedIn(): Boolean {
            return sharedPreferences.getBoolean("isLoggedIn",
                false)
        }
    ...
    //        }
        ...
        fun deleteTask(taskId: Long): Boolean {
            ...
            return try {
                ...
                Log.e("TaskDeletion", "Error deleting task", e)
                false
            } finally {
                db.endTransaction()
                db.close()
